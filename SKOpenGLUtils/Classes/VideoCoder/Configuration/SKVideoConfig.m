...
- (instancetype)init {
    ...
    if (self) {
        ...
        self.encoderType = SKVideoEncoderType_H264_Hardware;
        self.decoderType = SKVideoDecoderType_H264_Hardware;
    }
    return self;
}
...
+ (SKVideoConfig *)kConfig_480P_15fps {
    SKVideoConfig *config = [[SKVideoConfig alloc] init];
