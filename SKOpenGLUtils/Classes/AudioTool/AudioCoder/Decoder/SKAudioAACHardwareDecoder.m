...
#import "SKAudioAACHardwareDecoder.h"
#import "SKAudioError.h"


@interface SKAudioAACHardwareDecoder () {
...
@implementation SKAudioAACHardwareDecoder
...
OSStatus deconverterComplexCallBack(AudioConverterRef inAudioConverter,
    ...
    SKAudioAACHardwareDecoder *weakSelf = (__bridge SKAudioAACHardwareDecoder *)inUserData;
